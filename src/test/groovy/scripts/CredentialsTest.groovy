...
class CredentialsTest {
    ...
    private static final List SCRIPTS = ["main.groovy", "scripts/credentials.groovy", "config/scripts.config"]
    ...
    @BeforeClass
    static void setUp() {
        addScriptToLocalDataZip(CredentialsTest.class, SCRIPTS, SCRIPT_PATH, SCRIPT_TARGET, ["loader.groovy": resourcePath("loader/local.groovy", "")])
    }
    ...
    @WithPlugin(["hashicorp-vault-plugin-2.1.0.hpi", "hashicorp-vault-credentials-plugin-0.0.9.hpi", "credentials-binding-1.10.hpi",
            ...
            "ssh-credentials-1.13.hpi", "sauce-ondemand-1.164.hpi", "maven-plugin-2.7.1.hpi", "matrix-project-1.12.hpi",
