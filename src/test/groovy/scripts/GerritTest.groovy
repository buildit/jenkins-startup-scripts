...
class GerritTest {
    ...
    private static final List SCRIPTS = ["main.groovy", "scripts/gerrit.groovy", "config/scripts.config"]
    ...
    public static void setUp() {
        addScriptToLocalDataZip(GerritTest.class, SCRIPTS, SCRIPT_PATH, SCRIPT_TARGET, ["loader.groovy": resourcePath("loader/local.groovy", "")])
    }
