...
class GitlabTest  extends StartupTest {
    ...
    @WithPlugin(["gitlab-plugin-1.4.8.hpi", "credentials-2.1.16.hpi", "plain-credentials-1.4.hpi",
            ...
            "ssh-credentials-1.13.hpi", "junit-1.23.hpi", "script-security-1.44.hpi", "mailer-1.20.hpi", "scm-api-2.2.6.hpi",
            "workflow-scm-step-2.6.hpi", "structs-1.14.hpi", "apache-httpcomponents-client-4-api-4.5.3-2.1.hpi", "jsch-0.1.54.1.hpi",
            "display-url-api-2.2.0.hpi", "workflow-api-2.27.hpi"])
