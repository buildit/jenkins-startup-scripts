...
class MultiCloudTest extends StartupTest {

    @BeforeClass
    public static void setUp() {
        setUp(MultiCloudTest.class, ["scripts/mesos.groovy", "scripts/kubernetes.groovy"])
    }

    @Test
    @LocalData
    @ZipTestFiles(files = ["jenkins.config"])
    @WithPlugin(["mesos-0.14.1.hpi", "credentials-2.1.16.hpi", "metrics-3.1.2.10.hpi", "jackson2-api-2.8.10.1.hpi", "structs-1.14.hpi",
            "kubernetes-1.5.2.hpi", "workflow-step-api-2.14.hpi", "credentials-2.1.16.hpi", "durable-task-1.16.hpi", "variant-1.1.hpi",
