...
class SonarRunnerTest extends StartupTest {
    ...
    @Test
    @LocalData
    @WithPlugin(["sonar-2.6.1.hpi", "maven-plugin-3.1.2.hpi", "mailer-1.20.hpi", "javadoc-1.1.hpi", "junit-1.23.hpi",
            "jquery-1.11.2-0.hpi", "display-url-api-2.2.0.hpi", "workflow-step-api-2.14.hpi", "workflow-api-2.26.hpi",
            "script-security-1.40.hpi", "structs-1.14.hpi","scm-api-2.2.6.hpi","apache-httpcomponents-client-4-api-4.5.3-2.1.hpi",
            "jsch-0.1.54.1.hpi","jsch-0.1.54.1.hpi","ssh-credentials-1.13.hpi","credentials-2.1.16.hpi"])
